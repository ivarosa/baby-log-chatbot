...
HELP_MESSAGE = (
    ...
    "⏰ **Pengingat:**\n"
    "• `set reminder susu` - Pengingat minum susu\n"
    "• `set reminder makan` - Pengingat makan (NEW!)\n"  # ADD THIS
    "• `show reminders` / `show meal reminders`\n"  # ADD THIS
    "• **Respons cepat saat pengingat:**\n"
    "  • `done [volume]` / `done makan` - Tandai selesai\n"
    "  • `snooze [menit]` - Tunda pengingat\n"
    "  • `skip reminder` - Lewati pengingat\n\n"
    "💊 **Obat & Vitamin:**\n"
    "• `set reminder obat` / `lihat obat`\n"
    "• **Respons:** `taken [nama obat]`\n\n"
    "📊 **Laporan & Ringkasan:**\n"
...
PANDUAN_MESSAGE = (
    ...
    "• `show reminders` - Daftar pengingat susu aktif\n\n"
    "### **Pengingat Makan (NEW!):**\n"  # ADD THIS SECTION
    "• `set reminder makan` - Setup pengingat makan\n"
    "• `show meal reminders` - Daftar pengingat makan aktif\n"
    "• Jenis: Sarapan, Makan Siang, Makan Malam, Snack\n"
    "• Atur jam & hari tertentu\n\n"
    ...
    "## **IX. Pengingat Obat & Vitamin**\n"
    "• `set reminder obat` - Setup pengingat obat/vitamin\n"
    "• `lihat obat` - Daftar obat aktif\n"
    "• **Respons saat pengingat:**\n"
    "  • `taken [nama obat]` - Sudah minum\n"
    "  • `skip medication` - Lewati\n"
    "• `riwayat obat` - Riwayat konsumsi (7 hari)\n\n"
    "## **💡 Tips Penggunaan:**\n"
